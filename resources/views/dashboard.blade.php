...
<style>
    ...
    .sidebar-dark-primary .navbar-nav .nav-link:hover {
        color: white;
        /* Mengubah warna teks menjadi putih ketika disorot */
    }
</style>
...
<body class="hold-transition sidebar-mini">
    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="#" class="nav-link" style="color: #03045E"><b>Dashboard</b></a>
                </li>
            </ul>
            <!-- Right navbar links -->
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            <!-- Brand Logo -->
            <a href="/dashboard"
                class="brand-link d-flex justify-content-center align-items-center text-decoration-none">
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        searchInput.addEventListener('input', function() {
            ...
            rows.forEach(row => {
                const namaSiswa = row.querySelector('td:nth-child(4)').textContent
                    .toLowerCase();
                if (namaSiswa.includes(searchString)) {
                    row.style.display = '';
                } else {
