...
Route::get('/kegiatan-siswa',[HomeController::class, 'kegiatan']);
...
Route::patch('/update-status/{id}', [HomeController::class, 'updateStatus'])->name('laporan.updateStatus');
Route::patch('/feedback/{id}', [HomeController::class, 'feedback'])->name('laporan.feedback');
